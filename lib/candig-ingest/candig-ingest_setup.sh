...
# python $PWD/lib/candig-ingest/candigv2-ingest/generate_test_data.py --commit 27f4d0bf1a5fc7a69af633f626954feea0be42fd --prefix $CANDIG_SITE_LOCATION --tmp tmp/data/synthdata --delete
